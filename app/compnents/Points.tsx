...
const points = [{
    ...
    content: "עם ניסיון רב בהכנה של תלמידים למבחני הכניסה בפקולטאות שונות באיטליה, סוזי מציעה תוכנית לימודים מקיפה ומוכחת שתעזור לך לצבור את הביטחון והידע הדרושים כדי להצליח",
    icon: "/icons/BatteryCharging.svg"
},{
    header: "תמיכה לכל אורך הדרך",
    content: "אנחנו מבינים שההכנה למבחנים והגשת המסמכים עלולים להיות מרתיעים, ולכן סוזי שמחה לספק עזרה ותמיכה לאורך כל הדרך. מההרשמה למבחן, לפורטל universitaly ועד להרשמה לתור בקונסוליה",
