...
export default function Top() {
    return (
        <div className="relative h-screen">
            <Image src="/images/venice1.jpg" height="1000" width="1000" alt="" className="w-full h-screen absolute top-100 z-0" />
            <div className='w-full flex flex-col items-center text-right absolute z-10 h-screen'>
                <Image src="/images/susy_logo1.png" height="300" width="300" alt="" className="xl:mb-4 mt-12 xl:mt-20 " />
                <div className='flex justify-center items-center my-4'>
                    <div className="">
                        ...
                        <a className="bg-orange-500 text-white w-max rounded-full flex items-center justify-center px-2 py-1.5 mx-auto my-4" href="https://api.whatsapp.com/send?phone=9720587699722">
